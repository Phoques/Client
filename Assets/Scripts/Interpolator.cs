...
public class Interpolator : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        to = new TransformUpdate(NetworkManager.NetworkManagerInstance.ServerTick, false, transform.position);
        from = new TransformUpdate(NetworkManager.NetworkManagerInstance.InterpolationTick, false, transform.position);
        previous = new TransformUpdate(NetworkManager.NetworkManagerInstance.InterpolationTick, false, transform.position);
    }
    ...
    {
        if (tick <= NetworkManager.NetworkManagerInstance.InterpolationTick && !isTeleport)
            return;
